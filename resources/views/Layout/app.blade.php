        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a data-toggle="modal" data-target="#AddAdminModal"  class="dropdown-item">Add New Membar</a>
                    <div class="dropdown-divider"></div>
                    <a href="{{url('/AdminListPage')}}" class="dropdown-item">USER List</a>
                </div>
            </li>
        </ul>
    </nav>
    <aside class="main-sidebar sidebar-dark-danger elevation-1">
        <a href="/" class="brand-link">
            <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Mosque ADMIN</span>
        </a>
        <div class="sidebar ">
            <nav class="mt-2 pb-4">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{url('/AdminListPage')}}" class="nav-link"><i class="nav-icon far fa-user-circle"></i><p>User</p>
                        </a>
                    </li>
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{url('/ContactListPage')}}" class="nav-link"><i class="nav-icon fa-phone-square-alt"></i><p>Contact</p>
                        </a><i class="fas fa-notes-medical"></i>
                    </li> --}}
                    <li class="nav-item">
                        <a href="{{url('/SliderListPage')}}" class="nav-link"><i class="nav-icon fas fa-images"></i><p>Slider</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/CommitteeListPage')}}" class="nav-link"><i class="nav-icon fa fa-users"></i><p>Committee</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/AddressPage')}}" class="nav-link"><i class="nav-icon fas fa-address-book"></i><p>Address</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/BlogPage')}}" class="nav-link"><i class="nav-icon fas fa-rss-square"></i><p>Blog</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/NamajListPage')}}" class="nav-link"><i class="nav-icon far fa-envelope"></i><p>Namaj Time</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/AccountPage')}}" class="nav-link"><i class="nav-icon fas fa-dollar-sign"></i><p>AccountPage</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{url('/VideoIndex')}}" class="nav-link"><i class="nav-icon fas fa-video"></i><p>Video</p>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('/GetOthersSiteInfoIndex')}}" class="nav-link"><i class="nav-icon fas fa-notes-medical"></i><p>Others</p>
                        </a>
                    </li>
